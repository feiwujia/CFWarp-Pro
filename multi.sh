...
wget -N -6 https://cdn.jsdelivr.net/gh/feiwujia/EUserv-warp/wgcf
...
function upcore(){
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/feiwujia/CFWarp-Pro/upcore.sh&& chmod +x upcore.sh && ./upcore.sh
}
...
function up4(){
wget -N --no-check-certificate https://raw.githubusercontent.com/feiwujia/CFWarp-Pro/main/multi.sh && chmod +x multi.sh && ./multi.sh
}

function up6(){
echo -e nameserver 2a00:1098:2c::1 > /etc/resolv.conf
wget -6 -N --no-check-certificate https://raw.githubusercontent.com/feiwujia/CFWarp-Pro/main/multi.sh && chmod +x multi.sh && ./multi.sh
}
...
apt update
apt -y --no-install-recommends install openresolv dnsutils wireguard-tools
wget -N https://github.com/feiwujia/CFWarp-Pro/raw/main/wgcf
cp wgcf /usr/local/bin/wgcf
chmod +x /usr/local/bin/wgcf
echo | wgcf register
until [ $? -eq 0 ]
...
apt update
apt -y --no-install-recommends install openresolv dnsutils wireguard-tools
wget -N -6 https://cdn.jsdelivr.net/gh/feiwujia/CFWarp-Pro/wgcf
cp wgcf /usr/local/bin/wgcf
sudo chmod +x /usr/local/bin/wgcf
echo | wgcf register
until [ $? -eq 0 ]
